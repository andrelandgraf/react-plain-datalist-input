...
Just do it yourself by using the className props described below or copy-paste the default css from [here](https://github.com/andrelandgraf/react-datalist-input/blob/master/src/DataListInput.css).	
